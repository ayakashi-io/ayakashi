...
describe("cookies apiScraper", function() {
    ...
    test("when persistentSession is on, cookies are shared", function(done) {
        ...
        exec(`node lib/cli/cli.js run ./__tests__/__e2e__/persistentSession/cookies/api/test_files --clean --jsonConfig '${strConfig}'`,
        function(err) {
            if (err) {
